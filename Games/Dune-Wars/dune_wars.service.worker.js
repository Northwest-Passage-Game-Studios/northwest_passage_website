...
/** @type {string} */
const CACHE_VERSION = '1756172613|10701898009';
/** @type {string} */
const CACHE_PREFIX = 'Dune-Wars-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'dune_wars.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["dune_wars.html","dune_wars.js","dune_wars.offline.html","dune_wars.icon.png","dune_wars.apple-touch-icon.png","dune_wars.audio.worklet.js","dune_wars.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["dune_wars.wasm","dune_wars.pck"];
