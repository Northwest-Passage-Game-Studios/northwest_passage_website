...
/** @type {string} */
const CACHE_VERSION = '1773110098|194039252';
/** @type {string} */
const CACHE_PREFIX = 'Naughtry or Nice-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Naughtry or Nice.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Naughtry or Nice.html","Naughtry or Nice.js","Naughtry or Nice.offline.html","Naughtry or Nice.icon.png","Naughtry or Nice.apple-touch-icon.png","Naughtry or Nice.audio.worklet.js","Naughtry or Nice.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Naughtry or Nice.wasm","Naughtry or Nice.pck"];
