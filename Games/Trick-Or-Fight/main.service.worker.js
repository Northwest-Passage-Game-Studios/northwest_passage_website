...
/** @type {string} */
const CACHE_VERSION = '1765332532|891322000';
/** @type {string} */
const CACHE_PREFIX = 'New Game Project-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'main.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["main.html","main.js","main.offline.html","main.icon.png","main.apple-touch-icon.png","main.audio.worklet.js","main.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["main.wasm","main.pck","main.side.wasm"];
